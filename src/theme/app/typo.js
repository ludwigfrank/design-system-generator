...
const mergedStyles = themeId =>
    Object.keys(typographyStyles).reduce((acc, cur, ind, arr) => {
        TYPOGRAPHY_ALIGNMENTS.map((alignment, index) => {
            ...
            if (typographyStyles[cur].styleVariations) {
                Object.keys(typographyStyles[cur].styleVariations).forEach(
                    variation => {
                        const variationStyles =
                            typographyStyles[cur].styleVariations[variation]
